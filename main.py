...
def main():
    ...
    elif args.policy_name == "tf_DDPG":
        policy = tf_DDPG.DDPG(state_dim, action_dim, max_action)
    else:
        policy = tf_DDPG.DDPG_fast(state_dim, action_dim, max_action)
    ...
    with tf.contrib.summary.always_record_summaries():
        ...
        while total_timesteps.numpy() < args.max_timesteps:
            ...
            if done:
                print ("Total T: %d Episode Num: %d Episode T: %d Reward: %f" % (total_timesteps.numpy(), episode_num, episode_timesteps, episode_reward))
